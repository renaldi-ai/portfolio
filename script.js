...
function initContactForm() {
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        // Send via EmailJS (jalan tanpa backend, cocok untuk GitHub Pages)
        ...
        emailjs.send('service_b3eacik', 'template_b99tcyc', templateParams)
        .then(() => {
            showMessage('Pesan berhasil dikirim! Terima kasih, saya akan segera membalas.', 'success');
            contactForm.reset();
        })
        .catch(error => {
            console.error('EmailJS error:', error);
            showMessage('Gagal mengirim pesan. Silakan hubungi langsung via WhatsApp: 0895-4063-98540', 'error');
        })
        .finally(() => {
            // Reset button state
